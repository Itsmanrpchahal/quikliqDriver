...
class ForgotPasswordActivity : AppCompatActivity(), CountryCodePicker.OnCountryChangeListener,
    ...
    private fun forgetApiCall(toString: String, countryCode: String) {
        ...
        if (utility!!.isConnectingToInternet(this)) {
            ...
            requestsCall.ForgetPassword("ForgetPassword",toString,countryCode,"3").enqueue(object : retrofit2.Callback<JsonObject>
            {
...
//                             utility!!.relative_snackbar(parent_mobile!!, jsonObject.optString("message"), getString(R.string.close_up))
                        }
                    }else{
                        utility!!.relative_snackbar(
                            nointernet_parent!!,
