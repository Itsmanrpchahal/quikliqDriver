package com.quikliq.quikliqdriver.imagePicker;
...
public abstract  class PickerManager {
    ...
    protected Uri getImageFile()
    {
      ...
      //  return FileProvider.getUriForFile(getApplicationContext(), "com.gayar.app.fileprovider", photo);
    ...
    public void startCropActivity()
    {
        if(uCrop == null)
        {
            ...
            int greenColorValue = Color.parseColor("#000000");
            options.setToolbarColor(greenColorValue);
            options.setStatusBarColor(greenColorValue);
            options.setActiveWidgetColor(greenColorValue);
